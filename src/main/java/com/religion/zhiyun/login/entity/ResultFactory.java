...
import com.religion.zhiyun.login.entity.ResultCode;
...
public class ResultFactory {
    ...
    public static Result buildSuccessResult(LoginInfo data, String name) {
        return new Result (200, "成功", data,name);
    }
}
